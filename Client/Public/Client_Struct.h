...
namespace Client
{
	...
	{
		_int	iDamage			= { 0 };
		_float4 vAttackPos		= {};	// BH - For Checking Attacked Direction
		_uint	iAttackTag		= { 0 };
		string	strAttackInfo	= { "" };
	...
	using EFFECT_COMMON_UV_DESC = struct tagEffect_Common_Uv_Desc
	{
		...
		XMFLOAT2		vMaxUVSliceClipUVOffset = { 0.f, 0.f };
	...
	typedef struct tagPlayerInitializeDesc {
		wstring strModelTag = {};
		_float4 vInitialPos = {};
		_float4 vInitialLookAt = {};
		_int	iNavIndex = { -1 };
		_int	iPrevLevel = { -1 };

	}PLAYER_INITIALIZE_DESC,TRAVIS_INITIALIZE_DESC;

	typedef struct tagBattleInteractionDesc {
		CGameObject* pTarget = { nullptr };
		string strMonsterName = {};

	}BATTLE_INTERACTION_DESC;

	typedef struct tagPlayerAbility {
		_int iHealthLevel = { 0 };
		_int iAttackLevel = { 0 };
		_int iBatteryLevel = { 0 };
		_int iSkillLevel = { 0 };
		_int iSpecialAttackLevel = { 0 };
